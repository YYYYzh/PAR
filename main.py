...
parser.add_argument('--approach', default='inception_iccv', type=str, required=False, help='你可以选择inception、tresnet')
...
parser.add_argument('--initial-checkpoint', default='',required=False, type=str, metavar='PATH',
...
def main():
    ...
    # create model
    #model = backbone.__dict__[args.approach](pretrained=False, num_classes=attr_num)
    model = create_model(
        args.model,
        pretrained=args.pretrained,
        num_classes=attr_num,
    ...
    criterion = loss.asymmetric_loss.AsymmetricLossMultiLabel()
